...
from app.model.data.validators.field_validator import is_valid_uuid, is_valid_number, is_valid_delay_type, \
...
class DataType(Enum):
    ...
    DELAY=(DataTypeData(name="delay",  display_name="Delay", read_only=False, show_in_details=True, show_in_list=True), is_valid_number, "Not a valid number")
    ...
    LAST_UPDATE_DATETIME=(DataTypeData(name="last_update_datetime",  display_name="Last updated", read_only=True, show_in_details=False, show_in_list=True), is_valid_datetime, "Datetime is not valid")
    LAST_RUN_DATETIME=(DataTypeData(name="last_run_datetime",  display_name="Last updated", read_only=True, show_in_details=False, show_in_list=True), is_valid_datetime, "Datetime is not valid")
    CREATED_DATETIME=(DataTypeData(name="created_datetime",  display_name="Created", read_only=True, show_in_details=True, show_in_list=False), is_valid_datetime, "Datetime is not valid")

    def __init__(self, data, data_validator, error_message=""):
        self.data = data
